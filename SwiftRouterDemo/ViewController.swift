...
extension SwiftAction where T: BaseViewController {
    func showFirst(current: UIViewController?, title: String) {
        SwiftRouter.open(current: current, path: SwiftViewRouterAction.firstPage( title: title))
    }
    func showSecond(current: UIViewController?, title: String) {
        SwiftRouter.open(current: current, path: SwiftViewRouterAction.secondPage(title: title))
    }
    func showThird(current: UIViewController?, title: String) {
        SwiftRouter.open(current: current, path: SwiftViewRouterAction.thirdPage(title: title))
    }
}
